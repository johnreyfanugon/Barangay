...
<main class="auth-wrap">
    <section class="auth-hero" aria-hidden="true">
        ...
        <div class="hero-metrics">
            <article><strong>99.9%</strong><span>System Uptime</span></article>
            <article><strong>Secure</strong><span>Protected Sessions</span></article>
            <article><strong>Fast</strong><span>Realtime Access</span></article>
        </div>
    </section>
    <section class="auth-side">
        ...
        <section class="persona-section" aria-label="Team style cards">
            <h3>Hacker • Hipster • Hustler</h3>
            <p>Replace the pictures anytime by editing files in <code>assets/profiles/</code>.</p>
            <div class="persona-grid">
                <article class="persona-card">
                    <img src="assets/profiles/hacker.svg" alt="Hacker profile picture">
                    <h4>Hacker</h4>
                    <small>Technology & Security</small>
                </article>
                <article class="persona-card">
                    <img src="assets/profiles/hipster.svg" alt="Hipster profile picture">
                    <h4>Hipster</h4>
                    <small>Design & Experience</small>
                </article>
                <article class="persona-card">
                    <img src="assets/profiles/hustler.svg" alt="Hustler profile picture">
                    <h4>Hustler</h4>
                    <small>Operations & Growth</small>
                </article>
            </div>
        </section>
    </section>
